...
AS $function$
  ...
  FROM (VALUES
    ('subscription','basic_15',     0::numeric,  15::int,  NULL::int),
    ('subscription','basic_365',    0::numeric, 365::int,  NULL::int),
    ('subscription','basic_30',   399::numeric,  30::int,  NULL::int),
    ('subscription','premium_30', 149::numeric,  30::int,  NULL::int),
    ('subscription','premium_365',1465::numeric,365::int,  NULL::int),
    ('subscription','business_30',249::numeric,  30::int,  NULL::int),
    ('subscription','business_365',2450::numeric,365::int, NULL::int),
